...
import { Dumbbell, Activity, Utensils, ArrowLeft } from "lucide-react";

export default function CorpoLayout({
  children,
}: {
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-zinc-800 bg-zinc-900/50 p-6">
        ...
        <div className="mb-8 flex items-center gap-2">
            ...
            <div>
                ...
                <p className="text-xs text-zinc-500 mt-0.5">Saúde e Física Geral</p>
            </div>
        </div>
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <header className="md:hidden flex items-center justify-between p-4 border-b border-zinc-800 bg-zinc-900/50">
          ...
          <span className="font-bold text-emerald-500 flex items-center gap-2">
            <Dumbbell className="w-4 h-4" /> Corpo
          </span>
