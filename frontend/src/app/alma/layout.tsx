...
import { Sparkles, Gamepad2, Lightbulb, ArrowLeft } from "lucide-react";

export default function AlmaLayout({
  children,
}: {
    ...
    <div className="min-h-screen bg-zinc-950 flex">
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-zinc-800 bg-zinc-900/50 p-6">
        ...
        <div className="mb-8 flex items-center gap-2">
            ...
            <div>
                <h2 className="text-xl font-bold tracking-tight text-yellow-500">
                    Alma
                </h2>
                <p className="text-xs text-zinc-500 mt-0.5">Criatividade e Lazer</p>
            </div>
        </div>
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <header className="md:hidden flex items-center justify-between p-4 border-b border-zinc-800 bg-zinc-900/50">
          ...
          <span className="font-bold text-yellow-500 flex items-center gap-2">
            <Sparkles className="w-4 h-4" /> Alma
          </span>
